	...
	<?php
		if ($active == 'parent-grade') {
			?>
			<script src="<?php echo base_url('assets/js/main/parent-grade.js'); ?>"></script> 
			<?php
		}
		if ($active == 'parent-contact') {
			?>
			<script src="<?php echo base_url('assets/js/main/parent-contact.js'); ?>"></script> 
			<?php
		}
	?>
