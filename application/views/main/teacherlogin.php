<div class="login-box">
  	...
  	<div class="login-box-body">
    	<p class="login-box-msg">TEACHER LOGIN</p>
    	...
    	<form id="teacherloginForm">
            ...
            <button type="submit" class="btn btn-primary btn-block btn-flat" id="teacherlogin" name="signin"><i class="fa fa-sign-in"></i> SIGN IN</button>
    	</form>
  	</div>	
</div>